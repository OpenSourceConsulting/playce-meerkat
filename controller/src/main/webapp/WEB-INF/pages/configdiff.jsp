...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/jsdifflib/diffview.css">

<script type="text/javascript" src="<%=request.getContextPath()%>/resources/jsdifflib/diffview.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/jsdifflib/difflib.js"></script>
<style type="text/css">
body {
	font-size: 12px;
